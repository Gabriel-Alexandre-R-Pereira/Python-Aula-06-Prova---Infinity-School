...
while True:
    ...
    if op == "1":
        ...
        resposta_ao_usuario = listar(lista=lista_produtos), exibir_mensagem(mensagem="Fim da lista de produtos.") if verificar_lista(lista=lista_produtos) else exibir_mensagem("Não há produtos na lista.")
    elif op == "3":
        resposta_ao_usuario = filtrar_caros() if verificar_lista(lista=lista_produtos) else exibir_mensagem("Não há produtos na lista para serem filtrados.")
    elif op == "4":
